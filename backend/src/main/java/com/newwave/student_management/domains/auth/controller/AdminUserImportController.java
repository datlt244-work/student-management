...
public class AdminUserImportController {
    ...
    public ResponseEntity<byte[]> downloadTeacherTemplate() {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"Template_Teacher.xlsx\"")
                .contentType(
    ...
    public ResponseEntity<byte[]> downloadStudentTemplate() {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"Template_Student.xlsx\"")
                .contentType(
                        MediaType.parseMediaType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"))
                .body(excelBytes);
    }
