...
const stats = [
  ...
  },
  {
    ...
    trendBg: 'bg-orange-50 dark:bg-orange-900/20',
  },
]
...
const activities = [
  {
    ...
    initialsColor: 'text-blue-700 dark:text-blue-300',
    action: 'Login',
    actionBg: 'bg-blue-50 dark:bg-blue-900/30',
    actionColor: 'text-blue-700 dark:text-blue-300',
    actionRing: 'ring-blue-700/10 dark:ring-blue-400/20',
  ...
  },
  {
    ...
    user: 'Jane Smith',
    initials: 'JS',
    initialsBg: 'bg-pink-100 dark:bg-pink-900',
    initialsColor: 'text-pink-700 dark:text-pink-300',
    action: 'Update',
    actionBg: 'bg-purple-50 dark:bg-purple-900/30',
    actionColor: 'text-purple-700 dark:text-purple-300',
    actionRing: 'ring-purple-700/10 dark:ring-purple-400/20',
    details: 'Updated Grade 5 Physics Syllabus',
    status: 'Pending',
    statusType: 'pending',
  },
  {
    ...
    user: 'Admin User',
    initials: 'AD',
    initialsBg: 'bg-orange-100 dark:bg-orange-900',
    initialsColor: 'text-primary-dark dark:text-primary',
    action: 'Delete',
    actionBg: 'bg-red-50 dark:bg-red-900/30',
    actionColor: 'text-red-700 dark:text-red-300',
    actionRing: 'ring-red-600/10 dark:ring-red-400/20',
  ...
  },
  {
    ...
    user: 'System',
    initials: 'dns',
    initialsBg: 'bg-stone-100 dark:bg-stone-800',
    initialsColor: 'text-stone-600 dark:text-stone-300',
    action: 'Backup',
    actionBg: 'bg-stone-100 dark:bg-stone-800',
    actionColor: 'text-stone-600 dark:text-stone-300',
    actionRing: 'ring-stone-500/10 dark:ring-stone-400/20',
  ...
  },
  {
    ...
    user: 'Sarah Lee',
    initials: 'SL',
    initialsBg: 'bg-indigo-100 dark:bg-indigo-900',
    initialsColor: 'text-indigo-700 dark:text-indigo-300',
    action: 'Register',
    actionBg: 'bg-indigo-50 dark:bg-indigo-900/30',
    actionColor: 'text-indigo-700 dark:text-indigo-300',
    actionRing: 'ring-indigo-700/10 dark:ring-indigo-400/20',
    details: 'New student registration request',
    status: 'Pending',
    statusType: 'pending',
  },
]
...
function getStatusClasses(type: string) {
  switch (type) {
    ...
    case 'pending':
      return {
        wrapper:
          'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400 ring-yellow-600/20 dark:ring-yellow-500/20',
        dot: 'bg-yellow-600 dark:bg-yellow-400 animate-pulse',
      }
    case 'completed':
      return {
        wrapper:
          'bg-gray-50 dark:bg-gray-700/30 text-gray-600 dark:text-gray-300 ring-gray-500/10 dark:ring-gray-400/20',
  ...
  <div class="max-w-[1200px] w-full mx-auto p-6 md:p-10 flex flex-col gap-8">
    ...
    >
      ...
      <div class="flex items-center gap-2">
        <span
          class="text-xs font-medium px-3 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 border border-green-200 dark:border-green-800 flex items-center gap-1"
        >
          <span class="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
          System Online
        </span>
        <div
          class="text-sm text-slate-500 dark:text-slate-400 font-medium font-body bg-white dark:bg-surface-dark px-3 py-1 rounded-md border border-stone-200 dark:border-stone-700 shadow-sm"
        >
          {{ currentDate }}
        </div>
      </div>
        ...
        <div class="flex items-center gap-3">
          ...
          >
            <span
              ...
              :class="
                healthLoading ? 'animate-spin text-primary' : 'text-slate-500 dark:text-slate-300'
              "
            >
              refresh
            </span>
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              ...
              >
                ...
                <th
                  class="p-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 min-w-[300px]"
                >
                  Details
                </th>
                <th
            ...
            <tbody class="divide-y divide-stone-200 dark:divide-stone-800">
              ...
              >
                ...
                <td
                  class="p-4 text-sm font-medium text-slate-900 dark:text-white whitespace-nowrap"
                >
                  <div class="flex items-center gap-2">
                    <div
                      :class="[
                        ...
                        activity.initialsBg,
                        activity.initialsColor,
                      ]"
                    >
                      <span v-if="activity.isIcon" class="material-symbols-outlined text-[14px]">{{
                        activity.initials
                      }}</span>
                ...
                <td class="p-4">
                  <span
                    :class="[
                      ...
                      getStatusClasses(activity.statusType).wrapper,
                    ]"
                  >
                    <span
                      :class="[
                        'w-1.5 h-1.5 rounded-full',
                        getStatusClasses(activity.statusType).dot,
                      ]"
                    ></span>
                    {{ activity.status }}
                  </span>
